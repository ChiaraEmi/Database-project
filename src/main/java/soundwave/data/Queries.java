...
public final class Queries {
    ...
    public static final String INSERT_LIKE = 
       """
       INSERT INTO Like(Username, CodiceBrano)
       VALUES (?,?)
       """;
    ...
    public static final String SELECT_LIKED_SONGS = 
        ...
        SELECT 
            ...
            b.Titolo
        FROM Brani b
        JOIN Like l ON b.CodiceBrano = l.CodiceBrano WHERE l.Username = ?    
        """;
